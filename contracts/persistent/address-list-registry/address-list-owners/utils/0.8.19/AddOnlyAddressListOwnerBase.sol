...
abstract contract AddOnlyAddressListOwnerBase is IAddOnlyAddressListOwner {
    ...
    constructor(address _addressListRegistry, string memory _listDescription) {
        ...
        uint256 listId = IAddressListRegistry(_addressListRegistry)
            .createList({
            _owner: address(this), _updateType: IAddressListRegistry.UpdateType.AddOnly, _initialItems: new address[](0)
        });
        LIST_ID = listId;
