...
/// @title ITestSolvV2ConvertiblePriceOracleManager Interface
/// @author Enzyme Council <security@enzyme.finance>
/// @notice A test interface for Solv V2 Price Oracle Manager
interface ITestSolvV2ConvertiblePriceOracleManager {
    function getOracle(address _voucher) external view returns (address oracle_);

    function getPriceOfMaturity(address _voucher, uint64 _maturity)
        external
        view
