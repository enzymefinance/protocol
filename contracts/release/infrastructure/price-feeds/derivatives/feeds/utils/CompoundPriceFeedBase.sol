...
/// @title CompoundPriceFeedBase Contract
/// @author Enzyme Council <security@enzyme.finance>
/// @notice Base contract for price oracle for tokens using Compound forks
abstract contract CompoundPriceFeedBase is IDerivativePriceFeed, FundDeployerOwnerMixin {
