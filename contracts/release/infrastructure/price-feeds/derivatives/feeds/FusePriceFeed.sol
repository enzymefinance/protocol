...
import "./utils/CompoundPriceFeedBase.sol";

/// @title FusePriceFeed Contract
/// @author Enzyme Council <security@enzyme.finance>
/// @notice Price source oracle for Fuse Tokens (fTokens)
/// @dev Since Fuse is a fork of Compound, this contract simply inherits the CompoundPriceFeedBase contract.
...
contract FusePriceFeed is CompoundPriceFeedBase {
    using SafeMath for uint256;

    constructor(address _fundDeployer, address _weth)
        public
        CompoundPriceFeedBase(_fundDeployer, _weth)
    {}
}
