...
/// @title IntegrationCallWhitelist Contract
/// @author Melon Council DAO <security@meloncoucil.io>
/// @notice A whitelist of integration call signatures being allowed to call from a fund
/// @dev Integration call signatures can be removed but not added from whitelist
contract IntegrationCallWhitelist is CallOnIntegrationPreValidatePolicyBase, Bytes4ListPolicyMixin {
    ...
    function identifier() external pure override returns (string memory) {
        return "INTEGRATION_CALL_SIGNATURE_WHITELIST";
    }
