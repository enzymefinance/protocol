...
contract MockFund is PolicyManager {
    ...
    function testAssetBlacklist(address[5] addresses, uint[3] values) public
        isValidPolicy(addresses, values, 0x0)
    {
        //dummy
    }

    function testAssetWhitelist(address[5] addresses, uint[3] values) public
        isValidPolicy(addresses, values, 0x0)
    {
        //dummy
    }

    function testPriceTolerance(address[5] addresses, uint[3] values) public
        isValidPolicy(addresses, values, 0x0)
    {
        //dummy
    }
