...
let denominationAsset: StandardToken, denominationAssetUnit: BigNumber;
let depositToken: StandardToken, depositTokenUnit: BigNumber;
let miscAsset1: StandardToken, miscAsset1Unit: BigNumber, miscAsset2: StandardToken, miscAsset2Unit: BigNumber;
