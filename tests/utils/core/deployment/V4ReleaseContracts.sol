...
import {IUsdEthSimulatedAggregator} from "tests/interfaces/internal/IUsdEthSimulatedAggregator.sol";
...
function getMainnetDeployment() pure returns (Contracts memory) {
    return Contracts({
        ...
        // Infrastructure
        fundValueCalculator: IFundValueCalculator(0x490e64E0690b4aa481Fb02255aED3d052Bad7BF1),
...
function getPolygonDeployment() pure returns (Contracts memory) {
    return Contracts({
        ...
        // Infrastructure
        fundValueCalculator: IFundValueCalculator(0xcdf038Dd3b66506d2e5378aee185b2f0084B7A33),
...
function getArbitrumDeployment() pure returns (Contracts memory contracts_) {
    return Contracts({
        ...
        // Infrastructure
        fundValueCalculator: IFundValueCalculator(0xEA609eeB38D1EE8E8719597d47Cc9276df9f8707),
...
function getBaseChainDeployment() pure returns (Contracts memory contracts_) {
    return Contracts({
        ...
        // Infrastructure
        fundValueCalculator: IFundValueCalculator(0xb6257a6C3aef640A7D09E3Dd009A29308D2a321A),
