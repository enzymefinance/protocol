 ...
 * @test takeOrder: Order 1: take full amount
 * @test takeOrder: Order 2: take full amount w/ takerFee
 * TODO: takeOrder: Order 3: take partial amount w/ takerFee
 */
...
describe('takeOrder', () => {
  ...
  describe('Fill Order 1: no fees', () => {
    ...
    it('emits correct OrderFilled event', async () => {
      // TODO: ensure 1 event
      const orderFilled = getEventFromLogs(tx.logs, CONTRACT_NAMES.ZERO_EX_V2_ADAPTER, 'OrderFilled');
  ...
  // TODO: Order 3: partial fill w/ taker fee
});
