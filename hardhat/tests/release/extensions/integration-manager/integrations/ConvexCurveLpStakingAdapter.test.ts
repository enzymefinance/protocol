...
describe('actions', () => {
  ...
  describe('lendAndStake', () => {
    ...
    it('works as expected', async () => {
      ...
      expect(receipt).toMatchInlineGasSnapshot(`1525273`);
    });
  });
  ...
  describe('stake', () => {
    ...
    it('works as expected', async () => {
      ...
      expect(receipt).toMatchInlineGasSnapshot(`1280795`);
    });
  });
  ...
  describe('unstake', () => {
    ...
    it('works as expected', async () => {
      ...
      expect(receipt).toMatchInlineGasSnapshot(`1452456`);
    });
  });
  ...
  describe('unstakeAndRedeem', () => {
    ...
    it('works as expected', async () => {
      ...
      expect(receipt).toMatchInlineGasSnapshot(`1717764`);
    });
  });
});
