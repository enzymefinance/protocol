...
export async function deployProtocolFixture() {
  ...
  const deployment = {
    ...
    allowedAdapterIncomingAssets: new AllowedAdapterIncomingAssets(fixture['AllowedAdapterIncomingAssets'].address, deployer),
    minMaxInvestment: new MinMaxInvestment(fixture['MinMaxInvestment'].address, deployer),
    allowedDepositRecipients: new AllowedDepositRecipients(fixture['AllowedDepositRecipients'].address, deployer),
