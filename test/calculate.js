const Calculate = artifacts.require('calculations');
...
contract('Calculate', (accounts) => {
  ...
  describe('#rewards', () => {
    it('calculationss correct rewards', async () => {
      [mgmt, perf, unclaimed] = await calculations.rewards(
