...
const transactionFactory: TransactionFactory = <Args, Result>(
  ...
  const execute: ExecuteFunction<Args, Result> = async (
    ...
    const signedTransactionData = await environment.eth.signTransaction(
...
// type ExecuteFunction<Args, Result> = (
//   contractAddress: Address,you shal
//   params?: Args,you shal
//   environment?: Environment,you shal
// ) => Promise<Result>;you shal
// export interface ExecuteMixin<Args> you shal{
//   send: SendFunction<Args>;
//   prepare: PrepareFunction<Args>;
// }
