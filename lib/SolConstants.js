...
export const BITCOINTOKEN_OUTSTANDING_PRECISION =
    new BigNumber(10 ** PREMINED_OUTSTANDING_PRECISION);
export const DOLLARTOKEN_OUTSTANDING_PRECISION =
    new BigNumber(10 ** PREMINED_OUTSTANDING_PRECISION);
export const EUROTOKEN_OUTSTANDING_PRECISION = new BigNumber(10 ** PREMINED_OUTSTANDING_PRECISION);
